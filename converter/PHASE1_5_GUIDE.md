...
## 최근 변경 메모 (2025-11-20)
- 파서 관용성 확장: 탭→스페이스 치환, `<표 제목 : ...>` 뒤 빈 줄 건너뛰기, ◦/-,* 변형(•/∙/·, –/—, ●) 허용, `<주제목>/<강조>`가 다음 줄과 끊겨도 인식.
- 표 테두리 보강: Double-slim 테두리 세트(borderFill 12~17) 정의 및 행·열별 매핑(헤더 12/13/14, 본문 15/16/17, 마지막행 8). 추가 튜닝 필요 시 `CURRENT_ISSUES.md` 참조.
