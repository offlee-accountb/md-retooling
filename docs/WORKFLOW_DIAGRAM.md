...
#  STEP 1: 템플릿 분석
# ═══════════════════════════════════════════════════════════
$ python3 structured_injector.py template.hwpx --analyze
...
# ═══════════════════════════════════════════════════════════
#  STEP 2: 프롬프트 생성 (LLM에게 줄 질문)
# ═══════════════════════════════════════════════════════════
$ python3 structured_injector.py template.hwpx --prompt > prompt.md

# 또는 참고자료 포함
$ python3 structured_injector.py template.hwpx --prompt --context source.txt > prompt.md


# ═══════════════════════════════════════════════════════════
#  STEP 3: 데이터 수집 (LLM 또는 수동)
# ═══════════════════════════════════════════════════════════
# 옵션 A: LLM 호출
$ cat prompt.md | llm-cli --model haiku > data.md
...
#  STEP 4: HWPX 생성
# ═══════════════════════════════════════════════════════════
$ python3 structured_injector.py template.hwpx --md data.md --output result.hwpx
...
```
injector/
├── structured_injector.py   # 메인 통합 모듈
│   ├── MDParser             # MD → StructuredData
│   ├── TemplateAnalyzer     # HWPX → TemplateInfo
│   └── StructuredInjector   # 주입 실행
│
├── keyword_injector.py      # 키워드 전용 (레거시)
├── unified_injector.py      # 범용 주입기 (레거시)
└── template_analyzer.py     # 분석 전용 (레거시)
